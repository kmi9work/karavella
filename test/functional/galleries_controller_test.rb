...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { description: @gallery.description, name: @gallery.name, photo_id: @gallery.photo_id }
    end
  ...
  test "should update gallery" do
    put :update, id: @gallery, gallery: { description: @gallery.description, name: @gallery.name, photo_id: @gallery.photo_id }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
