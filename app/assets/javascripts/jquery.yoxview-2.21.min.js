...
// yoxthumbs:
 (function(h) {
    function n(d, a) {
        ...
        if (a.onClick) m ? d.bind("click.yoxthumbs",
        function(b) {
            a.onClick(b);
            return false
        }) : d.delegate("a:has(img)", "click.yoxthumbs",
        function(b) {
    ...
    h.fn.yoxthumbs = function(d) {
        ...
        } else if (a = h(this).data("yoxthumbs")) if (h.isFunction(a[d])) a[d].apply(a, Array.prototype.slice.call(arguments, 1));
        else return a[d];
        return this
    }
})(jQuery);
 ...
 (function(b) {
    function jb() {
        ...
        function na(a) {
            ...
            oa.stop().fadeIn(d.buttonsFadeTime,
            function() {
        ...
        function ea(a) {
            if (!l.cacheComplete) {
                ...
                var c = w[a].media;
                l.currentCacheImg = a;
                if (c && !c.loaded) if (!c.contentType || c.contentType === "image") bb.src = c.src;
                else cb(c,
                function() {
                    Ha()
                });
        ...
        function sb(a) {
            try {
                ...
                if (a.contentType === "image" || !a.contentType) {
                    ...
                    Oa.src = a.src
                } else ! a.loaded && a.contentType == "ooembed" ? cb(a,
                function(e) {
                    ta(e)
                },
                function(e) {
        ...
        this.init = function(a, c) {
            function e() {
                a.each(function(g, i) {
                    ...
                    J = [],
                    ya = 0; (Pa ? i: i.find(za(f))).each(function(v, Qa) {
                        var q = b(Qa),
                        p;
                        p = f;
                        var z = {},
                    ...
                    if (f.dataSource) Yox.dataSources[f.dataSource].getImagesData(f,
                    function(v) {
                        J = J.concat(v.images);
                        ka.images = J;
                        ...
                        Ua(i, f, Pa ? null: Qa, !v.createGroups ? null: function(q) {
                            ...
                            if (p.imagesAreSet) b.yoxview.open(p.viewIndex);
                                ...
                                Yox.dataSources[f.dataSource].getImagesData(F,
                                function(V) {
                                    p.images = V.images;
                                    p.imagesAreSet = true;
                                    z.css("cursor", "");
                        ...
                        v.createGroups ? b.each(i.yoxthumbs("thumbnails"),
                        function(q, p) {
                            p.data("yoxview", {
                                viewIndex: ++xa
                            });
        ...
        b(Oa).load(function() {
            this.width ==
            0 ? wa("Image error") : ta(b.extend({},
            b.yoxview.currentImage.media, {
                width: this.width,
                height: this.height
            }))
        }).error(function() {
    ...
    b.fn.yoxview = function(H) {
        if (this.length != 0) if (b.yoxview[H]) return b.yoxview[H].apply(this, Array.prototype.slice.call(arguments, 1));
